...
public class TestEvaluator
{
	...
	public void setUp() throws Exception
	{
		...
		dvp.addVariable( "_rates", new ValueObject( new Double[][]{ new Double[]{ 2.00, 3.00 }, new Double[]{ 4.00, 5.00 } }, Type.createType( Double[][].class ) ) );

		String[] names = new String[]{ "Kris", "Mohit", "Parmod" };
		dvp.addVariable( "_names", new ValueObject( names, Type.createType( names.getClass() ) ) );

		dvp.addVariable( "doublesWithNull", new ValueObject( new Double[]{ 2.00, 3.00, null }, Type.createType( Double[].class ) ) );

		dvp.addVariable( "doublesAllNull", new ValueObject( new Double[]{ null, null, null }, Type.createType( Double[].class ) ) );
		dvp.addVariable( "longsAllNull", new ValueObject( new Long[]{ null, null, null }, Type.createType( Long[].class ) ) );
		dvp.addVariable( "booleansAllNull", new ValueObject( new Boolean[]{ null, null, null }, Type.createType( Boolean[].class ) ) );
		...
		expressionContext.setContextProperty( ExpressionEngineConstants.EXPRESSION_CONTENXT_XML_PATH_URL, getClass().getClassLoader().getResource( "test.xml" ) );
	}
