...
public class ProductionRule implements IProductionRule
{
	...
	/**
	 * @see org.vedantatree.expressionoasis.grammar.rules.IProductionRule#isApproaching(String)
	 */
	...
	/**
	 * @see org.vedantatree.expressionoasis.grammar.rules.IProductionRule#isAllowed(String)
	 */
